...
=======
        ...
        self.pushButton_4.setObjectName("pushButton_4")
        self.verticalLayout_2.addWidget(self.pushButton_4)
        self.pushButton_4.clicked.connect(self.clickButton)  # 点触
        # lambda: self.clickButton("green")
        self.pushButton_5 = QtWidgets.QPushButton(self.Meau_WT)
...
=======
        ...
        self.showEdit = QtWidgets.QLineEdit(MainWindow)
        self.showEdit.setGeometry(QtCore.QRect(200, 100, 150, 60))
...
=======
    ...
    def clickButton(self, color):
        # self.left_color = color
        # sender = self.sender()
        # print(sender.text() + '被点击')
        self.showEdit.setText(" ")
        self.showEdit.setText(color)
